...
function propsStayedTheSame(prevSquare, nextSquare) {
  if (
    prevSquare.isWall === nextSquare.isWall &&
    prevSquare.currentStart[0] === nextSquare.currentStart[0] &&
    prevSquare.currentStart[1] === nextSquare.currentStart[1] &&
    prevSquare.currentEnd[0] === nextSquare.currentEnd[0] &&
    prevSquare.currentEnd[1] === nextSquare.currentEnd[1]
  ) {
    return true;
  } else {
    return false;
...
export default React.memo(Square, propsStayedTheSame);
